...
export const WithdrawSheet = memo(
  forwardRef<WithdrawDialogRef, WithdrawDialogProps>(
    ({ onClose, onSuccess }, ref) => {
      ...
      const handleCancelManualWithdraw = useCallback(() => {
        if (isManualSubmiting) return;
        setIsManualConfirmDialogOpen(false);
      }, [isManualSubmiting]);

      const handleConfirmManualWithdraw = useCallback(async () => {
        try {
      ...
      }, [transfer, maxAmount, success, t, resetForm, onSuccess, showError]);
                ...
                <VStack space="lg" className="w-full">
                  ...
                  <VStack space="md" className="w-full">
                    {preferredPrimaryChain === "USDC_BASE" && (
                      <Alert
                        action="info"
                        className="flex w-full flex-row items-start gap-4 rounded-xl"
                      ...
                      >
                        ...
                        <VStack className="flex-1">
                          ...
                          <AlertText
                            className="font-light text-typography-900 dark:text-typography-100"
                            size="xs"
                          >
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value } }) => (
                        ...
                        >
                          <FormControlLabel>
                            <FormControlLabelText size="sm" className="text-typography-700 dark:text-typography-300">
                        ...
                        >
                          ...
                          <VStack space="xs" className="w-full">
                            ...
                            <HStack className="w-full items-center justify-between">
                              ...
                              >
                                <ButtonText className="text-typography-600 dark:text-typography-400">
